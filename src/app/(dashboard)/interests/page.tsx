		...
		() => [
			{
				...
				cell: ({ row }) => (
					<div>
						...
						<p className="text-[11px] text-neutral-light font-mono">{row.original.slug}</p>
					</div>
				),
			},
			{
			...
			},
			{
				...
				header: "Image",
				cell: ({ row }) => (
					<span className="text-[11px] font-mono text-neutral-light truncate max-w-[160px] block">
	...
	if (!canManage) {
		return (
			<div className="p-6 max-w-7xl mx-auto">
				<p className="text-sm text-neutral-light">You don&apos;t have permission to view interests.</p>
			</div>
		)
	}
	...
	return (
		<div className="p-6 space-y-5 max-w-7xl mx-auto">
			...
			<div className="flex items-center gap-3">
				<h1 className="text-base font-semibold text-foreground">Interests</h1>
